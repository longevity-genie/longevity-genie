...
genetic_partial_variables = {
    "role": "You are a longevity geneticist.",
    "confidence": "For your final answer provide the CONFIDENCE SCORE ranging from 0 (don't know) to 100 (supported by direct quotes from sources and there are no contradictions between them). If there is a contradiction in sources, mention it explicetly in your answer and dicrease confidence score.",
    "additional_instructions": additional_instructions,
    "format": """ALWAYS return a "SOURCES" and part in your answer.""",
    "audience": """Your answer should address the audience with intermediate knowledge of genetics""",
    "examples": format_examples
}
genetic_wish = PromptTemplate(template=genetic_source_template,
                                input_variables=["summaries", "question"], partial_variables = genetic_partial_variables
                                )